                                        ...
                                        <div className={`relative overflow-hidden bg-gradient-to-br ${ts.grad}`}>
                                            ...
                                            <div className="absolute top-4 right-4 flex items-center gap-2">
                                                <a href={buildWhatsAppUrl(selected)} target="_blank" rel="noopener noreferrer" title="Compartilhar"
                                                    className="w-10 h-10 rounded-full bg-black/50 hover:bg-black/80 border border-white/10 flex items-center justify-center transition-colors backdrop-blur-md">
