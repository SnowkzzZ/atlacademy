                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex flex-col gap-2 mt-5">
                            ...
                            {training.presenterVideoUrl && (
                                <button
                                    onClick={() => setVideoOpen(true)}
                                    className="w-full flex items-center gap-3 py-3 px-4 rounded-2xl font-label text-[10px] font-bold tracking-[0.2em] uppercase bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 text-white/60 hover:text-white/80 transition-all duration-300 text-left"
                                >
                                    <span className="material-symbols-outlined text-[18px] text-white/30 shrink-0">videocam</span>
                                    <span>Recado do palestrante</span>
                                    <span className="material-symbols-outlined text-[14px] text-white/20 ml-auto">chevron_right</span>
                                </button>
                            )}
                ...
                {videoOpen && (
                    ...
                    >
                        ...
                        >
                            ...
                            <video
                                src={training.presenterVideoUrl}
                                controls
                                autoPlay
                                playsInline
                            ...
                            <p className="text-white/30 font-label text-[9px] tracking-widest uppercase text-center mt-3">
                                Recado do palestrante · {training.presenter}
                            </p>
                        </motion.div>
                    </motion.div>
                )}
