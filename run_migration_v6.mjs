...
const sql = readFileSync('supabase_update_v6.sql', 'utf-8');
...
async function run() {
    ...
    console.log('Could not execute via RPC. Please run the SQL queries manually on the Supabase dashboard.');
}
